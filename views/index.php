        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="explore-content ml-30">
                    <h2>¡Bienvenido al <?= TITLE; ?>  Su Puerta de Entrada a un Mundo de Experiencias. Más que un simple hospedaje, una aventura sensorial!</h2>
                    <p>¡Bienvenido al <?= TITLE; ?> Somos un oasis de bienestar y experiencias inolvidables. Al cruzar nuestras puertas, usted no solo ingresa a una habitación, sino que se embarca en un viaje a un mundo de sensaciones únicas.!</p>
...
<section class="facilities-area pb-60">
    <div class="container">
        <div class="section-title">
            ...
            <h2>Un destino lleno de aventuras</h2>
        </div>
        <div class="row">
            <div class="col-lg-3 col-sm-6">
...
<section class="incredible-area ptb-140 jarallax">
    <div class="container">
        <div class="incredible-content">
            <a href="https://vod-progressive.akamaized.net/exp=1710614108~acl=%2Fvimeo-prod-skyfire-std-us%2F01%2F930%2F14%2F354651355%2F1443116478.mp4~hmac=07a6b6f8893a62fc57928354d9803f393920035279bad3dc94ef4b0234e6b344/vimeo-prod-skyfire-std-us/01/930/14/354651355/1443116478.mp4?filename=file.mp4" class="video-btn popup-youtube">
                <i class="flaticon-play-button"></i>
            </a>
            <h2><span>¡Increíble!</span> Vas a venir hoy</h2>
            <p>"¡La emoción se apodera del aire! Estamos contando los segundos para verte hoy. Prepárate para una experiencia que superará todas tus expectativas."</p>
            <a href="#" class="default-btn">
...
<section class="our-rooms-area pt-60 pb-100">
    <div class="container">
        <div class="section-title">
            ...
            <h2>Habitaciones y suites asombrosas</h2>
        </div>
...
<section class="restaurants-area pb-100">
    <div class="container-fluid p-0">
        <div class="section-title">
            <span>Instalaciones</span>
            <h2>"¡Bienvenido al sabor Único!"</h2>
        </div>
        ...
        <div class="restaurants-wrap owl-carousel owl-theme">
            <div class="single-restaurants bg-1">
                ...
                <p>Un festín para tus sentidos: ¡Bienvenido a nuestro restaurante! Más que un lugar para comer, una experiencia gastronómica..</p>
                <a href="#" class="default-btn">
                    Explora más
                    <i class="flaticon-right"></i>
                </a>
            ...
            <div class="single-restaurants bg-2">
                ...
                <span>Piscina</span>
                <p>En este oasis de frescura y tranquilidad, te invitamos a desconectar del mundo exterior y sumergirte en un universo de relax y diversión sin fin.</p>
                <a href="#" class="default-btn">
                    Explora más
                    <i class="flaticon-right"></i>
                </a>
            ...
            <div class="single-restaurants bg-3">
                ...
                <p>En este entorno inspirador, los sueños se convierten en realidad y las ideas cobran vida.</p>
                <a href="#" class="default-btn">
                    Explora más
                    <i class="flaticon-right"></i>
                </a>
