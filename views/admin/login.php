...
<head>
	...
	<!--favicon-->
	<link rel="icon" href="<?php echo RUTA_PRINCIPAL; ?>assets/admin/images/logo.png" type="image/png" />
	<!--plugins-->
									...
									<div class="form-body">
										<form class="row g-3" id="formulario" autocomplete="off">
											<div class="col-12">
												...
												<input type="email" class="form-control" id="correo" name="correo" placeholder="Correo Electrónico" value="jonas@gmail.com">
											</div>
											<div class="col-12">
												<label for="clave" class="form-label">Contraseña</label>
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0" id="clave" name="clave" value="123456" placeholder="Contraseña"> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
												</div>
											</div>
											<div class="col-12">
												<div class="d-grid">
